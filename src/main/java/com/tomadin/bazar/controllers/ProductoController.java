...
import com.tomadin.bazar.dtos.request.ReponerStockRequest;
...
public class ProductoController {
    ...
    public ResponseEntity<List<ProductoResponse>> faltaStock() {
        return ResponseEntity.ok(productoService.getBajoStock());
    }
    ...
    @PatchMapping("/{id}/stock/reponer")
    public ResponseEntity<ProductoResponse> reponerStock(@PathVariable Long id,
                                                         @Valid @RequestBody ReponerStockRequest request) {
